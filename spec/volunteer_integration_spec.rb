...
describe 'the project delete path', {:type => :feature} do
  it 'allows a user to delete a project' do
    ...
    test_project.save
    id = test_project.id
    visit "/project/details/#{id}" # Minor edit to visit my details path
    click_link('Delete') # Changed for feature addition. Adds a confirmation page to ensure the user wants to delete the project.
...
describe 'the volunteer detail page path', {:type => :feature} do
  it 'shows a volunteer detail page' do
    ...
    test_volunteer.save
    visit "/project/details/#{project_id}" # Minor edit to visit my details path
    click_link('View Details') # Changed to accommodate a 'button link'
    click_link('Edit Volunteer') # Changed to accommodate a seperate form update page
